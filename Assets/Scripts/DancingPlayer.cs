...
public class DancingPlayer : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        _input.Dancing.SetAnim1.started += ActivateFirstAnim;
        _input.Dancing.SetAnim2.started += ActivateSecondAnim;
        _input.Dancing.SetAnim3.started += ActivatehirdAnim;
        _input.Dancing.SetAnim4.started += ActivateForthAnim;
        _input.Dancing.SetAnim5.started += ActivateFifthAnim;
        _input.Dancing.SetAnim0.started += ActivateZeroAnim;
